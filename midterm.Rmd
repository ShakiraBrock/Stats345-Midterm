...
bball_court <- geom_basketball("nba", display_range = "offense", rotation = 270, xlims = 248, ylims = 50)

bball_court + geom_point(data = bucks_shots, aes(locationX, locationY), color = "#2251b8")  
