...
bball_court <- geom_basketball("nba", display_range = "offense", rotation = 270)

bball_court + geom_point(data = bucks_shots, aes(locationX, locationY), color = "green") + scale_x_reverse()
